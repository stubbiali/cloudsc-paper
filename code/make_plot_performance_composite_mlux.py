...
from make_plot_performance_composite_daint import fill_ax_x0, fill_ax_x1, fill_ax_x2
...
def get_data(precision: Literal["double", "single"]) -> tuple[list[Bar], list[Bar], list[Bar]]:
    data_0 = [
        Bar(
            ds_name=os.path.join(ROOT_DIR, "cloudsc/mlux/nvhpc/22.7/release/performance.csv"),
            constraints={
                "variant": "fortran",
                "num_cols": NUM_COLS,
        ...
        Bar(
            ds_name=os.path.join(
                ROOT_DIR, "cloudsc/mlux/release/2022.1/gnu/11.3.0/performance.csv"
            ),
            constraints={
    ...
    data_1 = [
        Bar(
            ds_name=os.path.join(ROOT_DIR, "cloudsc2/mlux/nvhpc/22.7/release/performance.csv"),
            constraints={
                "variant": "nl",
                "num_cols": NUM_COLS,
                "num_threads": NUM_THREADS,
        ...
        Bar(
            ds_name=os.path.join(
                ROOT_DIR, "cloudsc2/mlux/release/2022.1/gnu/11.3.0/performance.csv"
            ),
            constraints={
