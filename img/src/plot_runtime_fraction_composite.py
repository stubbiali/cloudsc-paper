...
def main(show: bool, save: bool) -> None:
    ...
    # print(f"{data_00[0].y-data_stencils_00[0].y=}")
    # print(f"{data_00[2].y-data_stencils_00[2].y=}")
    # print(f"{data_00[4].y-data_stencils_00[4].y=}")
    # print(f"{data_01[0].y-data_stencils_01[0].y=}")
    # print(f"{data_01[2].y-data_stencils_01[2].y=}")
    # print(f"{data_01[4].y-data_stencils_01[4].y=}")
    # print(f"{data_02[0].y-data_stencils_02[0].y=}")
    # print(f"{data_02[2].y-data_stencils_02[2].y=}")
    # print(f"{data_02[4].y-data_stencils_02[4].y=}")
