...
%DIF DEL main_v0.tex   Fri Nov 29 10:58:06 2024
%DIF ADD main_v1.tex   Fri Nov 29 10:58:06 2024
...
% ============================================================
%DIF 257c257
%DIF < \graphicspath{{./../../img/v0}}
%DIF -------
\graphicspath{{./../../img/v1}} %DIF >
%DIF -------
...
\DIFdelend % ============================================================
	...
	\begin{figure}[t!]
		...
		\begin{minipage}{0.495\textwidth}
			\centering
			\includegraphics[scale=0.475]{workflow.pdf}
		\end{minipage}
		%\hfill
		\begin{minipage}{0.495\textwidth}
			\centering
			\includegraphics[scale=0.475]{workflow_dsl.pdf}
		\end{minipage}
	...
	\begin{figure}[t!]
		\centering
		\includegraphics[scale=0.5]{gt4py.pdf}
...
.}} \DIFaddend employed in the runs. \DIFaddbegin \DIFadd{Similarly, for all Python implementations we consider only the most performant backends of GT4Py: the GridTools C++ CPU backend with k-first memory layout, and the DaCe GPU backend.
	...
	\begin{figure}[t!]
		\centering
		\includegraphics[scale=0.44]{performance_daint.pdf}
	...
	\begin{figure}[t!]
		\centering
		\includegraphics[scale=0.44]{performance_mlux.pdf}
	...
	\begin{figure}[t!]
		\centering
		\includegraphics[scale=0.44]{performance_lumi.pdf}
	...
	The current study supports our ongoing efforts and plans to port other physical parametrizations to Python with GT4Py. However, we note that GT4Py has been originally devised to express the computational motifs of dynamical cores based on grid-point methods, so not all patterns found in the parametrizations are natively supported by the DSL. \DIFdelbegin \DIFdel{These cases may be addressed by new features added to }\DIFdelend \DIFaddbegin \DIFadd{In this respect, current limitations of the DSL exist for higher-dimensional fields (e.g., arrays storing a tensor at each grid point), but again we expect these to be fully supported for HPC with future extensions of }\DIFaddend GT4Py\DIFdelbegin \DIFdel{or by resorting to other Python libraries }\DIFdelend \DIFaddbegin \DIFadd{. In addition, Python offers a variety of alternative libraries that can be employed in conjunction with GT4Py }\DIFaddend to generate fast machine code.

	%DIF <  For instance, absolute indexing and off-center writing are not implemented, so workarounds are needed to update the surface layer from each vertical level and modify two consecutive vertical layers in conjunction.
	%DIF <  possibly recycling the prototype infrastructure code presented in this manuscript.
%DIF >  ============================================================
	%DIF >  appendix
	%DIF >  ============================================================
...
\DIFaddend
	...
	\DIFaddbegin \section{\DIFadd{Algorithmic description of the Taylor test and symmetry test for CLOUDSC2}}
