...
\begin{document}
    ...
    \begin{figure}[t!]
        ...
        \begin{minipage}{0.495\textwidth}
            \centering
            \includegraphics[scale=0.475]{img/workflow_2.pdf}
        \end{minipage}
        %\hfill
        \begin{minipage}{0.495\textwidth}
            \centering
            \includegraphics[scale=0.475]{img/workflow_dsl_2.pdf}
        \end{minipage}
