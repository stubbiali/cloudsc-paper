...
\begin{document}
	...
	\title{Exploring a high-level programming model for the NWP domain using the IFS microphysics schemes}
	...
	\runningtitle{Exploring a high-level programming model for the NWP domain using the IFS microphysics schemes}
